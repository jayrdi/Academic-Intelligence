    ...
    (function ($) {
        ...
        $.fn.loadGraph = function(graphData, graphSelect, graphColour) {
            ...
            if (graphData.length == 0) {
                $("." + graphSelect + "").append('<div class="panel panel-primary"><div class="panel-heading"><h3 class="panel-title">NO DATA</h3></div><div class="panel-body">There is no data available for this query</div></div>');
                                   ...
                                   .on("click", function (d) {
                                       switch (graphSelect) {
                                           ...
                                           default:
                                               ...
                                               var url = "https://www.google.co.uk/#q=" + d.personID;
                                               // add an href html element with the url attached
                                               $(location).attr("href", url);
                                               window.location = url;
                                               break;
