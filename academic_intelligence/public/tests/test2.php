 <?php
    ...
    $search_array = array(
        'queryParameters' => array(
            'databaseId' => 'WOS',
            'userQuery' => '(SO=landslide OR SO=earthquake engineering & structural dynamics OR SO=bulletin of earthquake engineering OR SO=geotechnique OR SO=engineering geology)',
            'editions' => array('collection' => 'WOS', 'edition' => 'SCI'),
            'timeSpan' => array('begin' => '1864-01-01', 'end' => '2015-01-01'),
            'queryLanguage' => 'en'
        ),
